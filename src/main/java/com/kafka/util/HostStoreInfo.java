...
/**
 * A simple bean that can be JSON serialized via Jersey. Represents a
 * KafkaStreams instance that has a set of state stores. See
 * {@link ExInteractiveQueriesRestService} for how it is used.
 *
